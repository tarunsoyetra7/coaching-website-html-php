    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                     <div class="col-lg-12">
                        <h4 align="center"><strong>Quiz Question Master</strong></h4>                         
					   <hr>                       
                       <ol class="breadcrumb">
		...
		<?php if(isset($_REQUEST['id'])){
			...
			que_priority,que_solution,que_cat_id from quiz_question_master where flag='true' and id=$id") or die("");
			$edit_q_res=$edit_q->fetch(PDO::FETCH_ASSOC);
?>
<form method="post" action="quiz_question_master_do.php" id="txt_form">
    <div class="col-lg-8">
...
function parent_child($id){
	...
	$q2=$db->query("select id,q_cat_title from online_test_category where q_cat_parent=$id and flag='true' and e_d_optn='true'") or die("");
...
<ul id="treeview" class="hummingbird-base list_category_list">
	<?php 
		$q1=$db->query("select id,q_cat_title from online_test_category where q_cat_parent=0 and flag='true' and e_d_optn='true'") or die("query");
		while($r1=$q1->fetch(PDO::FETCH_ASSOC)){ $m_id=$r1['id']; ?>
		<!--start level 1--->
		<li>
		<label><input type="checkbox" id="<?php echo $m_id; ?>" class="check_cat">
			...
			<ul>
				<?php
				$q2=$db->query("select id,q_cat_title from online_test_category where q_cat_parent=$m_id and flag='true' and e_d_optn='true'") or die("query");
				...
				<?php echo $r2['q_cat_title']; ?></label> 
					<ul>
						<?php
						$q3=$db->query("select id,q_cat_title from online_test_category where q_cat_parent=$m_id1 and flag='true' and e_d_optn='true'") or die("query");
						...
						<?php echo $r3['q_cat_title']; ?> </label>
							<ul>
								<?php
								$q4=$db->query("select id,q_cat_title from online_test_category where q_cat_parent=$m_id2 and flag='true' and e_d_optn='true'") or die("query");
