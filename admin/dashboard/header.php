...
<a style="color:#fff;" href="../log-out.php"><i class="fa fa-user"></i>&nbsp; Logout </a>                    
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <!---	<div align="center" style="padding:15px; background:#495B79; border-top:1px solid #D8E0E6;">
                <?php //if($userNameQ_res['profile_ext']=="" || $userNameQ_res['profile_ext']==NULL){  $userPROFILE="default_image.jpg"; } else { $userPROFILE=$l_id.".".$userNameQ_res['profile_ext'];;  } ?>
                	<img src="../../employee_profile/<?php //echo $userPROFILE; ?>" style="width:100px; height:100px; border-radius:50%;" />
                    <h5 align="center" style="color:#fff; margin-bottom:0px;"><strong><?php //echo $userNameQ_res['user_name']; ?> </strong></h5>
                </div>--->
