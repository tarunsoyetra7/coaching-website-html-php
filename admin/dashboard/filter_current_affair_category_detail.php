...
if(isset($_COOKIE['login']))
{
	...
	if(isset($_REQUEST['sel_val'])){
		...
		$query=$db->query("select id,ca_title,ca_cat_id,created_on,
							e_d_optn,flag from current_affair_detail where FIND_IN_SET('$sel_val',ca_cat_id) order by id desc") or die("");
