<?php
	if(isset($_COOKIE['login']))
	{
		...
		if(isset($_FILES['txtCsvFile']['name']))
		{
			...
			$txtSelTrainingInstitute=explode("|",$txtSelTrainingInstitute);
			$txtSelTrainingInstitute=$txtSelTrainingInstitute[0];
			/*
			...
			$txtSelCo=explode("|",$_REQUEST['txtSelCourse']);
			
			
			
			$course_id=$txtSelCo[1];
