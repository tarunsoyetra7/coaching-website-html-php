    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
						<h4 align="center"><strong>Menu Detail Master</strong></h4><hr>
...
<?php } ?>
 ...
 <table id="example1" class="table table-middle dataTable table-bordered table-condensed table-hover">
                            ...
                            <tbody id="filter_Res">
							<?php $query=$db->query("select id,m_title,m_cat_id,created_on,
							e_d_optn,flag from vocab_express_detail order by id desc") or die("");
 $i=0;
...
$("#sel_menu_cat").on("change",function(e){
	if($("#sel_menu_cat option:selected").val()=="s_m"){		
		...
		$.ajax({
			type:"POST",
			url:"filter_manage_vocab_detail.php",
