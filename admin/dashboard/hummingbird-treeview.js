(function($){
	...
	tree.find('input:checkbox').on('click', function(e) {
		...
		if ($(this).hasClass("hummingbird-end-node") === false) {
			...
			//alert("Checked id---"+$(this).parent("label").parent("li").find("input:checkbox:checked").attr('id'));
		    }
			...
			//alert("Unchecked id---"+$(this).parent("label").parent("li").find("input:checkbox:not(:checked)").attr('id'));
		    }
