    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
						<h4 align="center"><strong>Manage Blog Detail</strong></h4><hr>
					...
					<div class="col-lg-3"></div>
					 <div class="col-lg-6">
                                    ...
                                    <select class="form-control" name="sel_blog_cat" id="sel_blog_cat">
										...
										<?php $m_Q=$db->query("select id,b_cat_title from blog_category_master where flag='true' order by id desc") or die(""); while($m_Q_res=$m_Q->fetch(PDO::FETCH_ASSOC)){ ?>
		<option value="<?php echo $m_Q_res['id']; ?>"><?php echo $m_Q_res['b_cat_title']; ?></option>
<?php } ?>
                                    </select>
 ...
 <table id="example1" class="table table-middle dataTable table-bordered table-condensed table-hover">
                            ...
                            <tbody id="filter_Res">
							<?php $query=$db->query("select id,b_title,b_short_img,created_on,e_d_optn,flag,b_cat_id from
							blog_category_detail order by id desc") or die(""); $i=0;
