...
if(isset($_COOKIE['login']))
{
	...
	if(isset($_REQUEST['sel_val'])){
		...
		$query=$db->query("select id,job_title,job_cat_id,created_on,
							e_d_optn,flag from job_alert_detail where FIND_IN_SET('$sel_val',job_cat_id) order by id desc") or die("");
