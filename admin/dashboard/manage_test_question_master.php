    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
						<h4 align="center"><strong>Manage Question Master</strong></h4><hr>
...
<?php } ?>
 ...
 <table id="example1" class="table table-middle dataTable table-bordered table-condensed table-hover">
							...
							flag,que_priority from question_master order by que_priority desc") or die(""); $i=0;
...
$("#sel_blog_cat").on("change",function(e){
	if($("#sel_blog_cat option:selected").val()=="s_m"){		
		...
		$.ajax({
			type:"POST",
			url:"filter_test_question_master.php",
