    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
						<h4 align="center"><strong>Menu News Article Detail</strong></h4><hr>
                    ...
                    <div class="col-lg-12">
					 ...
					 <div class="col-lg-6">
                                    ...
                                    <label>Select News Article Category</label>
...
<?php } ?>
 ...
 <table id="example1" class="table table-middle dataTable table-bordered table-condensed table-hover">
                            ...
                            <tbody id="filter_Res">
							<?php $query=$db->query("select id,n_title,n_cat_id,created_on,
							e_d_optn,flag from news_article_detail order by id desc") or die("");
 $i=0;
...
$("#sel_menu_cat").on("change",function(e){
	if($("#sel_menu_cat option:selected").val()=="s_m"){		
		...
		$.ajax({
			type:"POST",
			url:"filter_news_article_category_detail.php",
