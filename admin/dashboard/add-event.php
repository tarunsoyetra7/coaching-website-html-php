...
<ol class="breadcrumb">
 ...
 <li class="active">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form" name="" method="post" enctype="multipart/form-data" action="add-event-do.php">
                                ...
                                <input required name="event_title"  type="text" class="form-control" placeholder="Enter Event Title">
                               <br>
