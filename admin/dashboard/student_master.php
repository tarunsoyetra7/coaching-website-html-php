...
<?php if(isset($_REQUEST['id'])){
	...
	$editQ=$db->query("SELECT id,certi_to_date,certi_frm_date,stud_name,stud_add,stud_email,stud_mo,stud_branch,stud_sem,stud_clg_name,stud_course,stud_fees,stud_paid_amnt,stud_discount,stud_balance,stud_recipt_optn,stud_certificate_no FROM student_master where id=$id and flag='true'") or die("");
	$editQ_res=$editQ->fetch(PDO::FETCH_ASSOC);

?>
<form name="" method="post" enctype="multipart/form-data" action="student_master_do.php" id="txt_form">
                                <div class="col-lg-6">
