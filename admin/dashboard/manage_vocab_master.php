    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
						<h4 align="center"><strong>Manage Vocab Express Master</strong></h4><hr>
 ...
 ?>
							...
							<td><?php echo $i; ?></td>
								...
								<?php if($result['m_img']=="" || $result['m_img']==NULL){ } else { ?>
									<img src="../../vocab_express_image/<?php echo $result['id'].".".$result['m_img']; ?>" style="width:30px; height:30px;">
								<?php } ?>
...
<script type="text/javascript">    
	...
	$(".btn_edit").on("click",function(e){
		...
		window.location.replace("vocab_express_master.php?id="+cur_id);
	});
