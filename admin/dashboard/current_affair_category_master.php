            ...
            <?php  include("header.php");  ?>
                <div id="page-wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 align="center"><strong>Current Affair Category  Master</strong></h4>
                                <hr>
...
<?php if(isset($_REQUEST['id'])){
	...
	$editQ=$db->query("select * from current_affair_category_master where id=$id") or die("");
	$editQ_res=$editQ->fetch(PDO::FETCH_ASSOC);
	//echo $editQ_res['id'];
	?>
	<form name="" method="post" enctype="multipart/form-data" action="cirrent_affair_category_master_do.php" id="txt_form">
                                <div class="col-lg-6">
                                    <label> Title</label>
...
if($editQ_res['cat_parent_id']==$m_Q_res['id']){
  ...
  <?php } ?>					
                                ...
                                <div class="col-lg-6">
									...
									<img src="../../current_affair_cat_img/<?php echo $editQ_res['id'].".".$editQ_res['cat_img']; ?>" style="width:30px; height:30px;">
									<?php } ?>
                                    <br>
