...
<div class="col-lg-12">
                        ...
                        <select class="form-control" id="txtSelCourse" name="txtSelCourse" autofocus>
                            ...
                            <?php $courseQ=$db->query("SELECT id,c_name,c_duration FROM course_master WHERE flag='true' ORDER BY id desc") or die("");
								while($courseQ_res=$courseQ->fetch(PDO::FETCH_ASSOC)){
									
									
									if($fetchQres['o_c_n_id']==$courseQ_res['id']){
										?>
                                           <option selected  value="<?php echo $courseQ_res['id']."|".$courseQ_res['c_name']; ?>"><?php echo $courseQ_res['c_name']."-".$courseQ_res['c_duration']; ?></option>
                                        <?php
									}
                 ...
                 <div class="col-lg-12">
                    ...
                    <div class="col-lg-1">
                    	<br>
                        <img src="../../center_profile/<?php echo $fetchQres['id'].".".$fetchQres['t_c_pro_img']; ?>" style="width:40px; height:40px;">
                    </div>
                    ...
                    <div class="col-lg-1" >
                    	<br>
                        <img src="../../center_aadhar/<?php echo $fetchQres['id'].".".$fetchQres['o_adhar_no']; ?>" style="width:40px; height:40px;">                    
                    </div>
...
<div class="col-lg-12">
                 ...
                 <div class="col-lg-12">
                    ...
                    <div class="col-lg-1">
                    	<br>
                        <img src="../../center_profile/<?php echo $fetchQres1['id'].".".$fetchQres1['t_c_pro_img']; ?>" style="width:40px; height:40px;">
                    </div>
                    ...
                    <div class="col-lg-1" >
                    	<br>
                        <img src="../../center_aadhar/<?php echo $fetchQres1['id'].".".$fetchQres1['o_adhar_no']; ?>" style="width:40px; height:40px;">                    
                    </div>
